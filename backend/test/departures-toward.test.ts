  ...
  t3: [
    {
      ...
      lat: 3.0,
      lon: 101.0,
      arrivalTime: "08:34:00",
      departureTime: "08:34:30",
      sequence: 1,
    },
    {
      stopId: "other",
      ...
      lat: 3.2,
      lon: 101.2,
      arrivalTime: "08:44:00",
      departureTime: "08:44:30",
      sequence: 2,
    },
  ],
};
...
describe("getDeparturesTowardDestination", () => {
  ...
  it("excludes trips going the opposite direction", () => {
    ...
    expect(
      result.departures.find((d) => d.destination === "Away From Dest"),
    ).toBeUndefined();
  });
  ...
  it("excludes trips that never reach the destination", () => {
    ...
    expect(
      result.departures.find((d) => d.destination === "Short Trip"),
    ).toBeUndefined();
  });
  ...
  it("throws for unknown stop", () => {
    expect(() =>
      getDeparturesTowardDestination(
        "unknown",
        "dest",
        stops,
        routes,
