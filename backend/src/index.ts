...
app.get('/route/:routeId', async (c) => {
  ...
  // Replaced chained array methods (.filter().map()) and Set allocation with a single loop
  // to avoid intermediate array allocations and reduce garbage collection overhead.
