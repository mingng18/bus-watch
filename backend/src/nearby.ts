...
export function findNearbyStops(
  ...
  // Performance optimization: Replace .map().filter() with a standard for loop to prevent
  // intermediate array allocations. Measurably reduces execution time for large arrays.
