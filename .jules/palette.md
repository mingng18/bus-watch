...
## 2024-06-21 - Avoid dead buttons for unsupported deep-links
...
**Action:** Instead, provide fallback text instructions (e.g., 'Enable in Watch Settings') within an `#else` block to provide a clear, non-interactive alternative and avoid user confusion.
