...
## 2025-02-28 - Optimize ASCII string sorting by avoiding localeCompare
...
**Action:** Used standard comparison operators (`a < b ? -1 : a > b ? 1 : 0`) for much faster lexicographical sorting.
