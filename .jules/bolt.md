...
## 2025-02-23 - Avoid localeCompare for simple ASCII sorting
...
**Action:** For basic lexicographical sorting of simple strings, use straightforward comparison operators (`a < b ? -1 : a > b ? 1 : 0`) which evaluate much faster.
