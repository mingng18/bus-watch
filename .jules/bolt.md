...
## 2024-08-20 - Fast ASCII String Sorting
...
**Action:** Instead, use simple comparison operators (`a < b ? -1 : a > b ? 1 : 0`) for much faster lexicographical sorting when the string format guarantees ASCII correctness.
